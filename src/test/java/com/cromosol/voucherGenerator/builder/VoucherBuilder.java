package com.cromosol.voucherGenerator.builder;
...
public class VoucherBuilder {
  ...
  public VoucherBuilder withBranch(int sucursal) {
  ...
  public VoucherBuilder withSubTotal(Long subTotal) {
    voucher.setSubTotal(subTotal);
    return this;
  }

  public VoucherBuilder withDiscount(Long discount) {
    voucher.setDiscount(discount);
    return this;
  }

  public VoucherBuilder withNetSubTotal(Long netSubTotal) {
