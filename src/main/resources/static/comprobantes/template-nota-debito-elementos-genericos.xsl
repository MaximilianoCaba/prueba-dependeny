...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="notaDebito">
        ...
        <fo:block>
            ...
            <fo:block>
                <xsl:call-template name="cuerpoNotaDebito">
                </xsl:call-template>
            </fo:block>
            <fo:block>
    ...
    <xsl:template name="anguloDerecho">
        <fo:block border="solid 0.1mm black" padding-left="3px">
            <fo:block>
                <xsl:call-template name="numeroNotaDebito">
                </xsl:call-template>
            </fo:block>
            <fo:block>
    ...
    <xsl:template name="numeroNotaDebito">
        <fo:block>
    ...
    <xsl:template name="logoTipoNotaDebito">
        <xsl:param name="copy"/>
        <fo:block>
            <fo:table table-layout="fixed" width="100%" border="none">
