...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="factura">
        ...
        <fo:block>
            ...
            <fo:block>
                <xsl:call-template name="cuerpoFactura">
                </xsl:call-template>
            </fo:block>
            <fo:block>
    ...
    <xsl:template name="anguloDerecho">
        <fo:block border="solid 0.1mm black" padding-left="3px">
            <fo:block>
                <xsl:call-template name="numeroFactura">
                </xsl:call-template>
            </fo:block>
            <fo:block>
    ...
    <xsl:template name="numeroFactura">
        <fo:block>
    ...
    <xsl:template name="logoTipoFactura">
        <xsl:param name="copy"/>
        <fo:block>
            <fo:table table-layout="fixed" width="100%" border="none">
