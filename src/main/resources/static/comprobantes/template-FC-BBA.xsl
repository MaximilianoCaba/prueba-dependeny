...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="logo">
        <fo:block text-align="left">
            <fo:external-graphic src="url('classpath:static/comprobantes/logo-bba.jpg')" content-height="25mm" scaling="uniform"/>
        </fo:block>
    </xsl:template>
    ...
    <xsl:template name="anguloIzquierdo">
        ...
        <fo:block font-size="8pt" text-align="left">
            ...
            <fo:block>
                ...
                Tel: (11) 4554.0267 | 0800-122-6765 | www.bbaautopartes.com / bba@bbaautopartes.com            </fo:block>
            <fo:block>
                ...
                <fo:table-row font-size="8pt">
                    <fo:table-cell text-align="left" padding="6px 0px 0px 0px" margin-right="2px"
                        ...
                        <fo:block-container height="15mm" margin-left="6px">
                            ...
                            <fo:block>
                                35 DIAS FECHA FACTURA = DTO 4
                            </fo:block>
                            <fo:block>
                                36 DIAS FECHA FACTURA = NETO
                            </fo:block>
                        </fo:block-container>
                    </fo:table-cell>
